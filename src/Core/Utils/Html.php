...
use MageArab\MegaFramework\Exceptions\JsonException;
use MageArab\MegaFramework\Exceptions\RegexpException;
use MageArab\MegaFramework\Interfaces;
 ...
 *
 * <code>
 * $el = Html::el('a')->href($link)->setText('MageArab');
 * $el->class = 'myclass';
 * echo $el;
 *
 ...
 * </code>
 */
class Html implements \ArrayAccess, \Countable, \IteratorAggregate, Interfaces\IHtmlString
{
     ...
     * @return static
     * @throws \MageArab\MegaFramework\Exceptions\RegexpException
     */
	 ...
	 * @param  Interfaces\IHtmlString|string  $html
	 * @return static
	 */
	 ...
	 * @param  Interfaces\IHtmlString|string|int|float  $text
	 * @return static
	 */
	final public function setText($text)
	{
		if (!$text instanceof Interfaces\IHtmlString) {
	 ...
	 * @param  Interfaces\IHtmlString|string  $child  Html node or raw HTML string
	 * @return static
	 */
